...
def set_gh_actions_versions(py_versions: Iterable[str]) -> List[str]:
	...
	if "3.11" in py_versions:
		py_versions[py_versions.index("3.11")] = "3.11"
	if "3.12-dev" in py_versions:
		py_versions[py_versions.index("3.12-dev")] = "3.12.0-alpha.6"
	if "3.12" in py_versions:
		py_versions[py_versions.index("3.12")] = "3.12.0-alpha.6"
